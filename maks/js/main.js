...
END PRELOADER JS*/
    ...
    /* --- Google Map --- */
	var mapLocation = new google.maps.LatLng(19.57180318620422, 72.77162532706505);  
	var $mapis = $('#map');
	if ($mapis.length > 0) {
		var map;
		map = new GMaps({
		...
		map.addMarker({
			...
			title: 'Solid',
			infoWindow: {
				content: '<p><strong>Green Flame </strong><br/>Vedhi village, Virathan Budruk, Saphale west, <br/>Tal & Dist – Palghar. Pin 401102<br/>Contact No. 9322486834</p>'
			}
		});
